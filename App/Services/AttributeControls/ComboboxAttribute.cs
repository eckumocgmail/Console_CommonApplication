...
/// <summary>
/// Маркер модели, указывает на неоходимость связывания модели с элементов управления "Combobox",
/// который предлагает выбор зависимой записи через выпадающий список и возможность добавления новых записей в зависимую таблицу.
/// </summary>
