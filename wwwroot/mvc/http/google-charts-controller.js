function GoogleChartsFactory( pelement ){
			...
			this.view=function( viewName,model ){
				...
				console.log('view', pars);
 				return window['https']({ url: '/View', type: 'GoogleChartsFactory', params: pars, headers: { 'Content-Type': 'text/json', Scope: pelement.id, Model: pelement?pelement.id.replace('view-',''): '' }, method: 'GET',}).then((r)=>{ window['checkout'](); return r; });
			}
