...
public class ViewOptions:   ActiveObjectContext
{
    public virtual bool Focusable { get => Get<bool>("Focusable"); set => Set<bool>("Focusable", value); }
    public virtual bool Focused { get => Get<bool>("Focused"); set => Set<bool>("Focused", value); }
    public virtual bool Selectable { get => Get<bool>("Selectable"); set => Set<bool>("Selectable", value); }
    public virtual bool Selected { get => Get<bool>("Selected"); set => Set<bool>("Selected", value); }
    public virtual bool MultiSelect { get => Get<bool>("Selected"); set => Set<bool>("Selected", value); }
    public virtual bool Dropable { get => Get<bool>("Dropable"); set => Set<bool>("Dropable", value); }
    public virtual bool Draggable { get => Get<bool>("Draggable"); set => Set<bool>("Draggable", value); }
    public virtual bool Editable { get => Get<bool>("Editable"); set => Set<bool>("Editable", value); }
