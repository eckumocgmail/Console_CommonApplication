...
public class StyledItem : ViewBuilder
{
    ...
    //[SelectControlAttribute("wait,w-resize,col-resize,grabbing,sw-resize,nw-resize,ne-resize,se-resize,e-resize,s-resize,n-resize,inherit")]
    ...
    [JsonIgnore()]
    [InputNumber(null)]
    [InputPositiveInt("Значение должно быть положительным")]
    [Units("px")]
...
/*
    //[SelectControlAttribute("left,right,justify")]
    ...
    public string GetCssText()
    {
        ...
        string cssText = new CssSerializer().Seriallize(valuesMap, AttrsUtils.ForAllPropertiesInType(typeof(StyledItem)));
        return cssText;
    }
