...
public class ViewBuilder: ViewFactory
{
    ...
    [Label("Источник")]
    [ComboboxAttribute("BusinessDatasource,Name")]
    public int DatasourceID { get; set; }

    
    [Label("Набор данных")]
    [ComboboxAttribute("BusinessDataset,Name")]
    ...
    private object GetBindedValue(string value, object data)
    {
        ...
        {
            return ObjectCompileExpExtensions.Expression.Compile(value, data);
        }
    ...
    {
        return ObjectCompileExpExtensions.Expression.Interpolate(expression, this);
    }
