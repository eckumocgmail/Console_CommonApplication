...
/// </summary>
public class PropertyChangeSupport: MyValidatableObject
{ 
    ...
    {
        //Api.Utils.Info(messageEvent.GetType().Name);
    ...
    public void MarkAsChanged(){
        Api.Utils.Info("I has changed =). " + GetType().Name + " " + GetHashCode());
        Changed = true;
    }
    ...
    public bool Changed
    {
        ...
        set
        {
            ...
            if (value == true)
            {
                Api.Utils.Info($"{GetType().Name} Changed "+GetHashCode());
            }*/
        }
    }
    ...
    {
        OnChange = (message) => {
            Api.Utils.Info(message.ToString());
        };
        Changed = false;
    }
    ...
    protected  T Get<T>(string key)  
    {
        ...
        else
        {
            if (EnableVerticalBinding)
            {
                ...
                {
                    PropertyChangeSupport parentSupport = (PropertyChangeSupport)Scope["Parent"];
    ...
    {        
        ...
        //Api.Utils.Info(GetType().Name + $".{key}:  {before} => {value} ");
        try
        {
            Scope[key] = value;    
            var attrs = AttrsUtils.ForProperty(this.GetType(), key);            
            var validationResult = this.ValidateProperty(key);
        ...
        catch(Exception ex)
        {
            ...
            Api.Utils.Info("Свойство "+key+" класса "+typeName+" не проверено");
