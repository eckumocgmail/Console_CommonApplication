...
public class ProductsSearchController 
{
        ...
        int PageSize = 100000)
    {
        ...
        if (!result.Success)
            throw new Exception($"Ошибка при получении сведений о продукции: {result.Exception}");
    ...
    /// </summary>           
    public virtual object OnInput(CatalogDataModel context, string value)
    {            
        var products =
