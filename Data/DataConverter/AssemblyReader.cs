...
public class AssemblyReader
{
    ...
    public static object CreateNewInstance(string name)
    {
        ...
        ConstructorInfo constructorDefaults = (from c in new List<ConstructorInfo>(type.GetConstructors()) where c.GetParameters().Length == 0 select c).FirstOrDefault();
